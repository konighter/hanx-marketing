...
<template>
  <el-form ref="formRef" :disabled="isDetail" :model="formData" :rules="rules" label-width="120px">
    ...
    <el-form-item label="商品单位" prop="brandId">
      <el-select v-model="formData.unitId" class="w-80" placeholder="请选择商品单位">
        <el-option
...
import type { Spu } from '@/app/erp/api/spu'
import {ProductCategoryApi, ProductCategoryVO} from '@/app/erp/api/product/category'
import * as ProductBrandApi from '@/app/erp/api/brand'
import { ProductUnitVO, ProductUnitApi } from '@/app/erp/api/product/unit'
...
const unitList = ref<ProductUnitVO[]>([]) // 商品单位列表
