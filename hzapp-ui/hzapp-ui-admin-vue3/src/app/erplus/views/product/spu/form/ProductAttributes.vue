...
<template>
  <el-col v-for="(item, index) in attributeList" :key="index">
    ...
    <div>
      ...
      <el-button v-show="!inputVisible(index)" class="button-new-tag ml-1" size="small" @click="showInput(index)">
        + 添加
      </el-button>
    </div>
...
import * as PropertyApi from '@/app/erplus/api/product/property'
import { PropertyAndValues } from '@/app/erplus/views/product/spu/components'
