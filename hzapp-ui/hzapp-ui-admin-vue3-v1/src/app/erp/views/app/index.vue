<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="应用Key" align="center" prop="appKey" />
...
import { AppApi, AppVO } from '@/app/erp/api/app/index'
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, '应用注册信息.xls')
  } catch {
  } finally {
