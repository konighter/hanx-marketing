...
// --- 添加到素材库
const addAssert = async (imageDetail: ImageVO) => {

  await ProductAssetsApi.createProductAssets({
    assetLink: imageDetail.picUrl,
    assetInfo: JSON.stringify(imageDetail),
    tags: 'AI生成',
    type: 20, // 图片
    source: AssetSourceEnum.AI // AI 生成
  } as ProductAssets)
