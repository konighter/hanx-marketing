...
export interface Dimension {
  ...
  weight?: number       // 重量
  volume?: number       // 商品体积
  unit?: string         // 长度单位, 默认cm
  weightUnit? : string  // 重量单位,默认 kg
}
...
export interface Sku {
  ...
  itemDim? : Dimension  // 净品规格
  pkgDim? : Dimension   // 包裹规格
  boxDim? : Dimension   // 单箱规格
  inboxnum? : number    // 单箱数量
...
export const spuListing = (data: any) => {
  return request.post({ url: '/erplus/listing/create', data })
}
