        ...
        <el-col :span="24">
          <el-form-item label="尺寸">
            <div class="flex items-center gap-2">
              <el-input v-model="formData.packageDimensions.length" class="flex-1" placeholder="长度" />


              <span class="text-gray-400">×</span>
              <el-input v-model="formData.packageDimensions.width" class="flex-1" placeholder="宽度" />
              <span class="text-gray-400">×</span>
              <el-input v-model="formData.packageDimensions.height" class="flex-1" placeholder="高度">

                <template #append>
                  <el-select v-model="formData.packageDimensions.unit" class="w-16" style="width: 80px;">
      ...
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="重量" prop="packageDimensions.weight">
            <el-input v-model="formData.packageDimensions.weight" class="w-full" placeholder="请输入重量">
              <template #append>
                <el-select v-model="formData.packageDimensions.weightUnit" class="w-16" style="width: 80px;">
