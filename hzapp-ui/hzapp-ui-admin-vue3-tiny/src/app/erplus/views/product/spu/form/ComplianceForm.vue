...
v-for="(material, index) in formData.materials" :key="index"
        ...
        <div>
          ...
          <div class="text-xs text-gray-500 mt-1">材料名称</div>
        </div>
...
v-model="material.percentage" placeholder="含量百分比" :min="0" :max="100" :precision="2"
        ...
        <el-select v-model="material.type" placeholder="材料类型" class="!w-50">
        ...
        <el-button @click="removeMaterial(index)" type="danger" size="small" circle class="mt-1">
          <Icon icon="ep:delete" />
        </el-button>
    ...
    <el-form-item label="碳足迹信息">
      <div class="!w-full">
        <el-input v-model="formData.carbonFootprint.value" placeholder="碳足迹值" :min="0" :precision="2" class="!w-80">
          <template #append>
            <el-select v-model="formData.carbonFootprint.unit" placeholder="单位" class="!w-30">
...
v-for="(license, index) in formData.specialLicenses" :key="index"
        ...
        <el-input v-model="license.number" placeholder="许可证编号" class="!w-50" />
        <el-date-picker v-model="license.expiryDate" type="date" placeholder="有效期" class="w-50" />
    ...
    <el-form-item label="质量检测报告">
      ...
      <el-upload v-model:file-list="formData.qualityReports" action="#" :auto-upload="false" multiple :limit="5">
    ...
    <el-form-item label="保修信息">
      <div class="flex flex-row items-start gap-2px">
        ...
        <div>
          <el-input-number v-model="formData.warranty.period" placeholder="保修期" :min="0" controls-position="right" />
          <div class="text-xs text-gray-500 mt-1">保修期</div>
        </div>

        <div>
          <el-select v-model="formData.warranty.unit" placeholder="单位" class="w-15!">
        ...
        <div>
          <el-select v-model="formData.warranty.type" placeholder="保修类型" class="w-30!">
