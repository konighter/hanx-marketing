...
import SaleOutReceiptEnableList from '@/app/erp/views/sale/out/components/SaleOutReceiptEnableList.vue'
import SaleReturnRefundEnableList from '@/app/erp/views/sale/return/components/SaleReturnRefundEnableList.vue'
import { SaleOutVO } from '@/app/erp/api/sale/out'
import { ErpBizType } from '@/utils/constants'
import { SaleReturnVO } from '@/app/erp/api/sale/return'
