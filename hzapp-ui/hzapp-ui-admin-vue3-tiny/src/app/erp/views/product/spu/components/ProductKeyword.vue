...
import * as PropertyApi from '@/app/erp/api/property'
import { PropertyVO } from '@/app/erp/api/property'
import { PropertyAndValues } from '@/app/erp/views/product/spu/components'
import { propTypes } from '@/utils/propTypes'

defineOptions({ name: 'ProductKeyword' })
