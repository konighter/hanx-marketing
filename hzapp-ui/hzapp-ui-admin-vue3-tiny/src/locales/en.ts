export default {
  ...
  login: {
    ...
    usernamePlaceholder: 'Username / Email / Mobile',
    ...
    accountMsg: 'Please enter your account',
    emailMsg: 'Please enter your email',
    passwordMsg: 'Please enter your password',
    confirmPasswordMsg: 'Please enter your password again',
    emailInvalid: 'Email format is incorrect',
    emailRegistered: 'This email is already registered',
    accountExists: 'Account already exists',
    usernameLengthMsg: 'Username length must be between 4 and 30',
    passwordLengthMsg: 'Password length must be between 5 and 20',
    passwordInvalid: 'Cannot contain illegal characters: < > " \' \\\ {\'|\'}',
    diffPwd: 'Two passwords are inconsistent',
