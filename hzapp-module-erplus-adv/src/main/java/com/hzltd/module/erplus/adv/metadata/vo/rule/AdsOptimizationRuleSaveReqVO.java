...
import com.hzltd.module.erplus.adv.enums.*;
...
public class AdsOptimizationRuleSaveReqVO {
    ...
    public static class OptimizationRule {
        ...
        private AdsOptimizationRuleCategoryEnum ruleCategory;
    ...
    public static class Action {
        ...
        private AdsOptimizationRuleActionTypeEnum actionType;
    }

    @Data
    public static class ActionDetails {
        @Schema(description = "动作操作符")
        private AdsOptimizationRuleOperatorEnum actionOperator;
        @Schema(description = "动作单位")
        private AdsOptimizationRuleUnitEnum actionUnit;
    ...
    public static class Recurrence {
        ...
        @Schema(description = "时间段设置")
        private List<TimeOfDay> timesOfDay;
        @Schema(description = "类型")
        private AdsOptimizationRuleRecurrenceTypeEnum type;
    }
