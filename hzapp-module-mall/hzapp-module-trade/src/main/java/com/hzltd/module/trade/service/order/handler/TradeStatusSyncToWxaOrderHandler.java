...
import com.hzltd.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hzltd.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "hzapp.trade.order", value = "status-sync-to-wxa-enable")
