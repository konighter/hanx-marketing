package com.hzltd.module.promotion.controller.app.article.vo.article;
...
public class AppArticleRespVO {
    ...
    @Schema(description = "文章标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "翰展科技 - 促销模块")
    private String title;

    @Schema(description = "文章作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "翰展科技")
