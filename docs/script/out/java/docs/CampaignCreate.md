...
|------------ | ------------- | ------------- | -------------|
|**adProduct** | **AdProduct** |  |  |
|**autoCreationSettings** | [**CreateAutoCreationSettings**](CreateAutoCreationSettings.md) |  |  [optional] |
...
|**optimizations** | [**CreateCampaignOptimizations**](CreateCampaignOptimizations.md) |  |  [optional] |
