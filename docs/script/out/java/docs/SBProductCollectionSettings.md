...
|**customImages** | [**List&lt;SBImage&gt;**](SBImage.md) | The set of custom images featured in the ad. |  |
...
|**landingPage** | [**SBProductCollectionLandingPage**](SBProductCollectionLandingPage.md) |  |  |
|**moderationStatus** | [**SBCreativeStatus**](SBCreativeStatus.md) |  |  [optional] |
|**products** | [**List&lt;SBAdvertisedProducts&gt;**](SBAdvertisedProducts.md) | The products featured in the ad. |  [optional] |
