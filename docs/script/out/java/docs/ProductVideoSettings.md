...
|**brandLogos** | [**List&lt;Image&gt;**](Image.md) | The brand logo image assets to be used in the ad. |  [optional] |
...
|**landingPage** | [**VideoLandingPage**](VideoLandingPage.md) |  |  [optional] |
|**moderationStatus** | [**CreativeStatus**](CreativeStatus.md) |  |  [optional] |
|**products** | [**List&lt;AdvertisedProducts&gt;**](AdvertisedProducts.md) | The products featured in the video ad. |  [optional] |
|**untranslatedHeadlines** | **List&lt;String&gt;** | The headline entered by the advertiser. |  [optional] |
|**untranslatedVideos** | [**List&lt;Video&gt;**](Video.md) | The original video assets submitted as part of the creative. |  |
|**videos** | [**List&lt;Video&gt;**](Video.md) | The video assets used in the ad. |  |
