...
|**brandLogos** | [**List&lt;SBImage&gt;**](SBImage.md) | The brand logo image assets to be used in the ad. |  |
|**cards** | [**List&lt;SBCardCreativeElement&gt;**](SBCardCreativeElement.md) | The sub-elements of the creative. Each card highlights a different ASIN associated to a brand Store. |  |
