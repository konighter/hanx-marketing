...
|**cards** | [**List&lt;CreateCardCreativeElement&gt;**](CreateCardCreativeElement.md) | The sub-elements of the creative. Each card highlights a different ASIN associated to a brand Store. |  |
...
|**landingPage** | [**CreateStoreSpotlightLandingPage**](CreateStoreSpotlightLandingPage.md) |  |  |
