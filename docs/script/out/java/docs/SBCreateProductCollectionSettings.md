...
|**customImages** | [**List&lt;SBCreateImage&gt;**](SBCreateImage.md) | The set of custom images featured in the ad. |  |
...
|**landingPage** | [**SBCreateProductCollectionLandingPage**](SBCreateProductCollectionLandingPage.md) |  |  |
