...
|**brandLogos** | [**List&lt;CreateImage&gt;**](CreateImage.md) | The brand logo image assets to be used in the ad. |  |
...
|**customImages** | [**List&lt;CreateImage&gt;**](CreateImage.md) | The set of custom images featured in the ad. |  |
...
|**landingPage** | [**CreateProductCollectionLandingPage**](CreateProductCollectionLandingPage.md) |  |  |
|**products** | [**List&lt;CreateAdvertisedProducts&gt;**](CreateAdvertisedProducts.md) | The products featured in the ad. |  [optional] |
