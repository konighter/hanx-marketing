...
|**cards** | [**List&lt;SBCreateCardCreativeElement&gt;**](SBCreateCardCreativeElement.md) | The sub-elements of the creative. Each card highlights a different ASIN associated to a brand Store. |  [optional] |
...
|**landingPage** | [**SBUpdateStoreSpotlightLandingPage**](SBUpdateStoreSpotlightLandingPage.md) |  |  [optional] |
