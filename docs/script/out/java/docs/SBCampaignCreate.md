...
|**autoCreationSettings** | [**SBCreateAutoCreationSettings**](SBCreateAutoCreationSettings.md) |  |  [optional] |
|**brandId** | **String** | This is the ID of the brand that the campaign is associated with. |  [optional] |
|**budgets** | [**List&lt;SBCreateBudget&gt;**](SBCreateBudget.md) | The object containing budget details for the campaign (for campaigns that support multiple budgets). |  |
|**costType** | **SBCostType** |  |  |
...
|**optimizations** | [**SBCreateCampaignOptimizations**](SBCreateCampaignOptimizations.md) |  |  [optional] |
...
|**state** | **SBCreateState** |  |  |
|**tags** | [**List&lt;SBCreateTag&gt;**](SBCreateTag.md) | Open ended labels with a key value pair applied to the campaign |  [optional] |
