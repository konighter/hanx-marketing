...
|------------ | ------------- | ------------- | -------------|
|**activeCreative** | [**SBCreative**](SBCreative.md) |  |  [optional] |
...
|**creative** | [**SBCreative**](SBCreative.md) |  |  |
...
|**tags** | [**List&lt;SBTag&gt;**](SBTag.md) | Open ended labels with a key value pair applied to the ad |  [optional] |
