...
import tiktokshop.open.sdk_java.model.Promotion.V202309.GetActivityResponseDataDiscount;
import tiktokshop.open.sdk_java.model.Promotion.V202309.GetActivityResponseDataParticipationLimit;
import tiktokshop.open.sdk_java.model.Promotion.V202309.GetActivityResponseDataProducts;
...
public class GetActivityResponseData {
  ...
  public GetActivityResponseData addActivityCommandsItem(String activityCommandsItem) {
  ...
  public GetActivityResponseData addParticipationLimitItem(GetActivityResponseDataParticipationLimit participationLimitItem) {
  ...
  public GetActivityResponseData addProductsItem(GetActivityResponseDataProducts productsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetActivityResponseData promotion202309GetActivityResponseData = (GetActivityResponseData) o;
    return Objects.equals(this.activityCommands, promotion202309GetActivityResponseData.activityCommands) &&
        Objects.equals(this.activityId, promotion202309GetActivityResponseData.activityId) &&
        Objects.equals(this.activityType, promotion202309GetActivityResponseData.activityType) &&
        Objects.equals(this.beginTime, promotion202309GetActivityResponseData.beginTime) &&
        Objects.equals(this.createTime, promotion202309GetActivityResponseData.createTime) &&
        Objects.equals(this.discount, promotion202309GetActivityResponseData.discount) &&
        Objects.equals(this.durationType, promotion202309GetActivityResponseData.durationType) &&
        Objects.equals(this.endTime, promotion202309GetActivityResponseData.endTime) &&
        Objects.equals(this.participationLimit, promotion202309GetActivityResponseData.participationLimit) &&
        Objects.equals(this.productLevel, promotion202309GetActivityResponseData.productLevel) &&
  ...
  public String toString() {
    ...
    sb.append("class GetActivityResponseData {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("discount") != null && !jsonObj.get("discount").isJsonNull()) {
        GetActivityResponseDataDiscount.validateJsonElement(jsonObj.get("discount"));
      }
      ...
      if (jsonObj.get("participation_limit") != null && !jsonObj.get("participation_limit").isJsonNull()) {
        ...
        if (jsonArrayparticipationLimit != null) {
          ...
          for (int i = 0; i < jsonArrayparticipationLimit.size(); i++) {
            GetActivityResponseDataParticipationLimit.validateJsonElement(jsonArrayparticipationLimit.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("products") != null && !jsonObj.get("products").isJsonNull()) {
        ...
        if (jsonArrayproducts != null) {
          ...
          for (int i = 0; i < jsonArrayproducts.size(); i++) {
            GetActivityResponseDataProducts.validateJsonElement(jsonArrayproducts.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetActivityResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetActivityResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetActivityResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetActivityResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<GetActivityResponseData>() {
           @Override
