...
public class SearchSizeChartsResponseDataSizeChartImages {
  ...
  public String toString() {
    ...
    sb.append("class SearchSizeChartsResponseDataSizeChartImages {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchSizeChartsResponseDataSizeChartImages.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchSizeChartsResponseDataSizeChartImages' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchSizeChartsResponseDataSizeChartImages> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchSizeChartsResponseDataSizeChartImages.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchSizeChartsResponseDataSizeChartImages>() {
           @Override
