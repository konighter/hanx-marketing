...
public class GetTrackingResponse {
  ...
  public GetTrackingResponse code(Integer code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public GetTrackingResponse data(GetTrackingResponseData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public void setData(GetTrackingResponseData data) {
    this.data = data;
  }


  public GetTrackingResponse message(String message) {
  ...
  **/
  ...
  public GetTrackingResponse requestId(String requestId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTrackingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTrackingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
