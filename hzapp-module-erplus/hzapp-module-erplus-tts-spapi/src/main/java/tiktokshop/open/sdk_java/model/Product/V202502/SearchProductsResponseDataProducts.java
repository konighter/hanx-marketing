...
public class SearchProductsResponseDataProducts {
  ...
  **/
  ...
  public SearchProductsResponseDataProducts productFamilies(List<SearchProductsResponseDataProductsProductFamilies> productFamilies) {
  ...
  **/
  ...
  public void setProductFamilies(List<SearchProductsResponseDataProductsProductFamilies> productFamilies) {
    this.productFamilies = productFamilies;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audit, createTime, id, integratedPlatformStatuses, isNotForSale, listingQualityTier, productFamilies, productSyncFailReasons, recommendedCategories, salesRegions, skus, status, title, updateTime);
  }
