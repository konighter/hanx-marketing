...
public class UpdateShopWebhookRequestBody {
  ...
  public UpdateShopWebhookRequestBody address(String address) {
  ...
  **/
  ...
  public UpdateShopWebhookRequestBody eventType(String eventType) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, eventType);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateShopWebhookRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateShopWebhookRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
