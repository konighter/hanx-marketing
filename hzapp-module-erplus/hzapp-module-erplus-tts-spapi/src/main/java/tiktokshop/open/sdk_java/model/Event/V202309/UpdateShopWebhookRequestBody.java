...
public class UpdateShopWebhookRequestBody {
  ...
  public UpdateShopWebhookRequestBody() {
  }

  public UpdateShopWebhookRequestBody address(@javax.annotation.Nullable String address) {
  ...
  public UpdateShopWebhookRequestBody eventType(@javax.annotation.Nullable String eventType) {
   ...
   * @return the UpdateShopWebhookRequestBody instance itself
   */
  public UpdateShopWebhookRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateShopWebhookRequestBody event202309UpdateShopWebhookRequestBody = (UpdateShopWebhookRequestBody) o;
    return Objects.equals(this.address, event202309UpdateShopWebhookRequestBody.address) &&
        Objects.equals(this.eventType, event202309UpdateShopWebhookRequestBody.eventType)&&
        Objects.equals(this.additionalProperties, event202309UpdateShopWebhookRequestBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, eventType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateShopWebhookRequestBody {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("address", "event_type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateShopWebhookRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateShopWebhookRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateShopWebhookRequestBody is not found in the empty JSON string", UpdateShopWebhookRequestBody.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateShopWebhookRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateShopWebhookRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateShopWebhookRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateShopWebhookRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateShopWebhookRequestBody>() {
           @Override
           public void write(JsonWriter out, UpdateShopWebhookRequestBody value) throws IOException {
           ...
           @Override
           public UpdateShopWebhookRequestBody read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateShopWebhookRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UpdateShopWebhookRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateShopWebhookRequestBody
   * @throws IOException if the JSON string is invalid with respect to UpdateShopWebhookRequestBody
   */
  public static UpdateShopWebhookRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateShopWebhookRequestBody.class);
  }

  /**
   * Convert an instance of UpdateShopWebhookRequestBody to an JSON string
   *
   * @return JSON string
   */
