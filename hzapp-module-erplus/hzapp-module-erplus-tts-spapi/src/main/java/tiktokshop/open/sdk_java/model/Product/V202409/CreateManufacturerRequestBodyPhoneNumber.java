...
public class CreateManufacturerRequestBodyPhoneNumber {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class CreateManufacturerRequestBodyPhoneNumber {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateManufacturerRequestBodyPhoneNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateManufacturerRequestBodyPhoneNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateManufacturerRequestBodyPhoneNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateManufacturerRequestBodyPhoneNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateManufacturerRequestBodyPhoneNumber>() {
           @Override
