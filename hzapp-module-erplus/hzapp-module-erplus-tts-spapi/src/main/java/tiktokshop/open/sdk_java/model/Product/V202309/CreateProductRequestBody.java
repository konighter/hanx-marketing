...
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyCertifications;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyMainImages;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyPackageDimensions;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyPackageWeight;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyProductAttributes;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodySizeChart;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodySkus;
import tiktokshop.open.sdk_java.model.Product.V202309.CreateProductRequestBodyVideo;
...
public class CreateProductRequestBody {
  ...
  public CreateProductRequestBody brandId(@javax.annotation.Nullable String brandId) {
  ...
  public CreateProductRequestBody categoryId(@javax.annotation.Nullable String categoryId) {
  ...
  public CreateProductRequestBody categoryVersion(@javax.annotation.Nullable String categoryVersion) {
  ...
  public CreateProductRequestBody certifications(@javax.annotation.Nullable List<CreateProductRequestBodyCertifications> certifications) {
  ...
  public void setCertifications(@javax.annotation.Nullable List<CreateProductRequestBodyCertifications> certifications) {
    this.certifications = certifications;
  }


  public CreateProductRequestBody deliveryOptionIds(@javax.annotation.Nullable List<String> deliveryOptionIds) {
  ...
  public CreateProductRequestBody description(@javax.annotation.Nullable String description) {
  ...
  public CreateProductRequestBody externalProductId(@javax.annotation.Nullable String externalProductId) {
  ...
  public CreateProductRequestBody idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public CreateProductRequestBody isCodAllowed(@javax.annotation.Nullable Boolean isCodAllowed) {
  ...
  public CreateProductRequestBody isNotForSale(@javax.annotation.Nullable Boolean isNotForSale) {
  ...
  public CreateProductRequestBody isPreOwned(@javax.annotation.Nullable Boolean isPreOwned) {
  ...
  public CreateProductRequestBody listingPlatforms(@javax.annotation.Nullable List<String> listingPlatforms) {
  ...
  public CreateProductRequestBody mainImages(@javax.annotation.Nullable List<CreateProductRequestBodyMainImages> mainImages) {
  ...
  public void setMainImages(@javax.annotation.Nullable List<CreateProductRequestBodyMainImages> mainImages) {
    this.mainImages = mainImages;
  }


  public CreateProductRequestBody manufacturerIds(@javax.annotation.Nullable List<String> manufacturerIds) {
  ...
  public CreateProductRequestBody minimumOrderQuantity(@javax.annotation.Nullable Integer minimumOrderQuantity) {
  ...
  public CreateProductRequestBody packageDimensions(@javax.annotation.Nullable CreateProductRequestBodyPackageDimensions packageDimensions) {
  ...
  public void setPackageDimensions(@javax.annotation.Nullable CreateProductRequestBodyPackageDimensions packageDimensions) {
    this.packageDimensions = packageDimensions;
  }


  public CreateProductRequestBody packageWeight(@javax.annotation.Nullable CreateProductRequestBodyPackageWeight packageWeight) {
  ...
  public void setPackageWeight(@javax.annotation.Nullable CreateProductRequestBodyPackageWeight packageWeight) {
    this.packageWeight = packageWeight;
  }


  public CreateProductRequestBody primaryCombinedProductId(@javax.annotation.Nullable String primaryCombinedProductId) {
  ...
  public CreateProductRequestBody productAttributes(@javax.annotation.Nullable List<CreateProductRequestBodyProductAttributes> productAttributes) {
  ...
  public void setProductAttributes(@javax.annotation.Nullable List<CreateProductRequestBodyProductAttributes> productAttributes) {
    this.productAttributes = productAttributes;
  }


  public CreateProductRequestBody responsiblePersonIds(@javax.annotation.Nullable List<String> responsiblePersonIds) {
  ...
  public CreateProductRequestBody saveMode(@javax.annotation.Nullable String saveMode) {
  ...
  public CreateProductRequestBody shippingInsuranceRequirement(@javax.annotation.Nullable String shippingInsuranceRequirement) {
  ...
  public CreateProductRequestBody sizeChart(@javax.annotation.Nullable CreateProductRequestBodySizeChart sizeChart) {
  ...
  public void setSizeChart(@javax.annotation.Nullable CreateProductRequestBodySizeChart sizeChart) {
    this.sizeChart = sizeChart;
  }


  public CreateProductRequestBody skus(@javax.annotation.Nullable List<CreateProductRequestBodySkus> skus) {
    this.skus = skus;
    return this;
  }
  ...
  public void setSkus(@javax.annotation.Nullable List<CreateProductRequestBodySkus> skus) {
    this.skus = skus;
  }


  public CreateProductRequestBody title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateProductRequestBody video(@javax.annotation.Nullable CreateProductRequestBodyVideo video) {
    this.video = video;
    return this;
  }
  ...
  public void setVideo(@javax.annotation.Nullable CreateProductRequestBodyVideo video) {
    this.video = video;
  }
   ...
   * @return the CreateProductRequestBody instance itself
   */
  public CreateProductRequestBody putAdditionalProperty(String key, Object value) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("brand_id", "category_id", "category_version", "certifications", "delivery_option_ids", "description", "external_product_id", "idempotency_key", "is_cod_allowed", "is_not_for_sale", "is_pre_owned", "listing_platforms", "main_images", "manufacturer_ids", "minimum_order_quantity", "package_dimensions", "package_weight", "primary_combined_product_id", "product_attributes", "responsible_person_ids", "save_mode", "shipping_insurance_requirement", "size_chart", "skus", "title", "video"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateProductRequestBody>() {
           ...
           public CreateProductRequestBody read(JsonReader in) throws IOException {
             ...
             CreateProductRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
