...
public class ProductV202309Api {
     ...
     * @param includeProhibitedCategories A flag to indicate whether to include categories that are prohibited on TikTok Shop. Set this to &#x60;true&#x60; to identify which are the product categories that you can&#39;t list on TikTok Shop in any circumstances. Applicable only for BR, MX, EU and SEA markets. (optional)
     * @param shopCipher  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public okhttp3.Call product202309CategoriesGetCall(String xTtsAccessToken, String contentType, String locale, String keyword, String categoryVersion, String listingPlatform, Boolean includeProhibitedCategories, String shopCipher, final ApiCallback _callback) throws ApiException {
        ...
        if (includeProhibitedCategories != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("include_prohibited_categories", includeProhibitedCategories));
        }
    ...
    private okhttp3.Call product202309CategoriesGetValidateBeforeCall(String xTtsAccessToken, String contentType, String locale, String keyword, String categoryVersion, String listingPlatform, Boolean includeProhibitedCategories, String shopCipher, final ApiCallback _callback) throws ApiException {
        ...
        return product202309CategoriesGetCall(xTtsAccessToken, contentType, locale, keyword, categoryVersion, listingPlatform, includeProhibitedCategories, shopCipher, _callback);
     ...
     * @param xTtsAccessToken  (required)
     * @param contentType Allowed type: multipart/form-data (required)
     * @param data The local image file to be uploaded.  **Note**: - Supported formats: JPG, JPEG, PNG, WEBP, HEIC, BMP - Max size: 10MB - Dimensions: [100x100 px, 20000x20000 px] - For &#x60;use_case&#x3D;MAIN_IMAGE&#x60;, the dimensions must be between 300x300 px and 4000x4000 px. - For &#x60;use_case&#x3D;SIZE_CHART_IMAGE&#x60;, the dimension must be at least 1024 px on the shorter side. (optional)
