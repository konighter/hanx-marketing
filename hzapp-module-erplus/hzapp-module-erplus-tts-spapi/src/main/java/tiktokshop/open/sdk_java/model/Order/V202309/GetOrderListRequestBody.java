...
public class GetOrderListRequestBody {
  ...
  public GetOrderListRequestBody buyerUserId(@javax.annotation.Nullable String buyerUserId) {
  ...
  public GetOrderListRequestBody createTimeGe(@javax.annotation.Nullable Long createTimeGe) {
  ...
  public GetOrderListRequestBody createTimeLt(@javax.annotation.Nullable Long createTimeLt) {
  ...
  public GetOrderListRequestBody isBuyerRequestCancel(@javax.annotation.Nullable Boolean isBuyerRequestCancel) {
  ...
  public GetOrderListRequestBody orderStatus(@javax.annotation.Nullable String orderStatus) {
  ...
  public GetOrderListRequestBody shippingType(@javax.annotation.Nullable String shippingType) {
  ...
  public GetOrderListRequestBody updateTimeGe(@javax.annotation.Nullable Long updateTimeGe) {
  ...
  public GetOrderListRequestBody updateTimeLt(@javax.annotation.Nullable Long updateTimeLt) {
  ...
  public GetOrderListRequestBody warehouseIds(@javax.annotation.Nullable List<String> warehouseIds) {
   ...
   * @return the GetOrderListRequestBody instance itself
   */
  public GetOrderListRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buyerUserId, order202309GetOrderListRequestBody.buyerUserId) &&
        ...
        Objects.equals(this.additionalProperties, order202309GetOrderListRequestBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buyerUserId, createTimeGe, createTimeLt, isBuyerRequestCancel, orderStatus, shippingType, updateTimeGe, updateTimeLt, warehouseIds, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("buyer_user_id", "create_time_ge", "create_time_lt", "is_buyer_request_cancel", "order_status", "shipping_type", "update_time_ge", "update_time_lt", "warehouse_ids"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetOrderListRequestBody>() {
           ...
           public GetOrderListRequestBody read(JsonReader in) throws IOException {
             ...
             GetOrderListRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
