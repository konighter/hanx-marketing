...
public class DataReconciliationV202401Api {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DataReconciliationV202401Api() {
        this(Configuration.getDefaultApiClient());
    }

    public DataReconciliationV202401Api(ApiClient apiClient) {
    ...
    /**
     * Build call for dataReconciliation202401OrdersImportPost
     * @param xTtsAccessToken  (required)
     * @param contentType Allowed type: application/json (required)
     * @param shopCipher  (optional)
     * @param dataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody  (optional)
    ...
    public okhttp3.Call dataReconciliation202401OrdersImportPostCall(@javax.annotation.Nonnull String xTtsAccessToken, @javax.annotation.Nonnull String contentType, @javax.annotation.Nullable String shopCipher, @javax.annotation.Nullable QualityFactoryOrderDataImportAPIRequestBody dataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = dataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody;

        // create path and map variables
        String localVarPath = "/data_reconciliation/202401/orders/import";
    ...
    private okhttp3.Call dataReconciliation202401OrdersImportPostValidateBeforeCall(@javax.annotation.Nonnull String xTtsAccessToken, @javax.annotation.Nonnull String contentType, @javax.annotation.Nullable String shopCipher, @javax.annotation.Nullable QualityFactoryOrderDataImportAPIRequestBody dataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody, final ApiCallback _callback) throws ApiException {
        ...
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling dataReconciliation202401OrdersImportPost(Async)");
        }

        return dataReconciliation202401OrdersImportPostCall(xTtsAccessToken, contentType, shopCipher, dataReconciliation202401QualityFactoryOrderDataImportAPIRequestBody, _callback);
