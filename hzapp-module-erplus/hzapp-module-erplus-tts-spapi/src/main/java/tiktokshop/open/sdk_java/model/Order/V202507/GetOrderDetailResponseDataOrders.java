...
import tiktokshop.open.sdk_java.model.Order.V202507.GetOrderDetailResponseDataOrdersHandlingDuration;
import tiktokshop.open.sdk_java.model.Order.V202507.GetOrderDetailResponseDataOrdersLineItems;
import tiktokshop.open.sdk_java.model.Order.V202507.GetOrderDetailResponseDataOrdersPackages;
import tiktokshop.open.sdk_java.model.Order.V202507.GetOrderDetailResponseDataOrdersPayment;
import tiktokshop.open.sdk_java.model.Order.V202507.GetOrderDetailResponseDataOrdersRecipientAddress;
...
public class GetOrderDetailResponseDataOrders {
  ...
  public boolean equals(Object o) {
    ...
    GetOrderDetailResponseDataOrders order202507GetOrderDetailResponseDataOrders = (GetOrderDetailResponseDataOrders) o;
    return Objects.equals(this.autoCombineGroupId, order202507GetOrderDetailResponseDataOrders.autoCombineGroupId) &&
        Objects.equals(this.buyerEmail, order202507GetOrderDetailResponseDataOrders.buyerEmail) &&
        Objects.equals(this.buyerMessage, order202507GetOrderDetailResponseDataOrders.buyerMessage) &&
        Objects.equals(this.cancelOrderSlaTime, order202507GetOrderDetailResponseDataOrders.cancelOrderSlaTime) &&
        Objects.equals(this.cancelReason, order202507GetOrderDetailResponseDataOrders.cancelReason) &&
        Objects.equals(this.cancelTime, order202507GetOrderDetailResponseDataOrders.cancelTime) &&
        Objects.equals(this.cancellationInitiator, order202507GetOrderDetailResponseDataOrders.cancellationInitiator) &&
        Objects.equals(this.channelEntityNationalRegistryId, order202507GetOrderDetailResponseDataOrders.channelEntityNationalRegistryId) &&
        Objects.equals(this.collectionDueTime, order202507GetOrderDetailResponseDataOrders.collectionDueTime) &&
        Objects.equals(this.collectionTime, order202507GetOrderDetailResponseDataOrders.collectionTime) &&
        Objects.equals(this.commercePlatform, order202507GetOrderDetailResponseDataOrders.commercePlatform) &&
        Objects.equals(this.consultationId, order202507GetOrderDetailResponseDataOrders.consultationId) &&
        Objects.equals(this.cpf, order202507GetOrderDetailResponseDataOrders.cpf) &&
        Objects.equals(this.cpfName, order202507GetOrderDetailResponseDataOrders.cpfName) &&
        Objects.equals(this.createTime, order202507GetOrderDetailResponseDataOrders.createTime) &&
        Objects.equals(this.deliveryDueTime, order202507GetOrderDetailResponseDataOrders.deliveryDueTime) &&
        Objects.equals(this.deliveryOptionId, order202507GetOrderDetailResponseDataOrders.deliveryOptionId) &&
        Objects.equals(this.deliveryOptionName, order202507GetOrderDetailResponseDataOrders.deliveryOptionName) &&
        Objects.equals(this.deliveryOptionRequiredDeliveryTime, order202507GetOrderDetailResponseDataOrders.deliveryOptionRequiredDeliveryTime) &&
        Objects.equals(this.deliverySlaTime, order202507GetOrderDetailResponseDataOrders.deliverySlaTime) &&
        Objects.equals(this.deliveryTime, order202507GetOrderDetailResponseDataOrders.deliveryTime) &&
        Objects.equals(this.deliveryType, order202507GetOrderDetailResponseDataOrders.deliveryType) &&
        Objects.equals(this.exchangeSourceOrderId, order202507GetOrderDetailResponseDataOrders.exchangeSourceOrderId) &&
        Objects.equals(this.fastDeliveryProgram, order202507GetOrderDetailResponseDataOrders.fastDeliveryProgram) &&
        Objects.equals(this.fastDispatchSlaTime, order202507GetOrderDetailResponseDataOrders.fastDispatchSlaTime) &&
        Objects.equals(this.fulfillmentType, order202507GetOrderDetailResponseDataOrders.fulfillmentType) &&
        Objects.equals(this.handlingDuration, order202507GetOrderDetailResponseDataOrders.handlingDuration) &&
        Objects.equals(this.hasUpdatedRecipientAddress, order202507GetOrderDetailResponseDataOrders.hasUpdatedRecipientAddress) &&
        Objects.equals(this.id, order202507GetOrderDetailResponseDataOrders.id) &&
        Objects.equals(this.isBuyerRequestCancel, order202507GetOrderDetailResponseDataOrders.isBuyerRequestCancel) &&
        Objects.equals(this.isCod, order202507GetOrderDetailResponseDataOrders.isCod) &&
        Objects.equals(this.isExchangeOrder, order202507GetOrderDetailResponseDataOrders.isExchangeOrder) &&
        Objects.equals(this.isOnHoldOrder, order202507GetOrderDetailResponseDataOrders.isOnHoldOrder) &&
        Objects.equals(this.isReplacementOrder, order202507GetOrderDetailResponseDataOrders.isReplacementOrder) &&
        Objects.equals(this.isSampleOrder, order202507GetOrderDetailResponseDataOrders.isSampleOrder) &&
        Objects.equals(this.lineItems, order202507GetOrderDetailResponseDataOrders.lineItems) &&
        Objects.equals(this.needUploadInvoice, order202507GetOrderDetailResponseDataOrders.needUploadInvoice) &&
        Objects.equals(this.orderType, order202507GetOrderDetailResponseDataOrders.orderType) &&
        Objects.equals(this.packages, order202507GetOrderDetailResponseDataOrders.packages) &&
        Objects.equals(this.paidTime, order202507GetOrderDetailResponseDataOrders.paidTime) &&
        Objects.equals(this.payment, order202507GetOrderDetailResponseDataOrders.payment) &&
        Objects.equals(this.paymentAuthCode, order202507GetOrderDetailResponseDataOrders.paymentAuthCode) &&
        Objects.equals(this.paymentCardType, order202507GetOrderDetailResponseDataOrders.paymentCardType) &&
        Objects.equals(this.paymentMethodCode, order202507GetOrderDetailResponseDataOrders.paymentMethodCode) &&
        Objects.equals(this.paymentMethodName, order202507GetOrderDetailResponseDataOrders.paymentMethodName) &&
        Objects.equals(this.pickUpCutOffTime, order202507GetOrderDetailResponseDataOrders.pickUpCutOffTime) &&
        Objects.equals(this.recipientAddress, order202507GetOrderDetailResponseDataOrders.recipientAddress) &&
        Objects.equals(this.releaseDate, order202507GetOrderDetailResponseDataOrders.releaseDate) &&
        Objects.equals(this.replacedOrderId, order202507GetOrderDetailResponseDataOrders.replacedOrderId) &&
        Objects.equals(this.requestCancelTime, order202507GetOrderDetailResponseDataOrders.requestCancelTime) &&
        Objects.equals(this.rtsSlaTime, order202507GetOrderDetailResponseDataOrders.rtsSlaTime) &&
        Objects.equals(this.rtsTime, order202507GetOrderDetailResponseDataOrders.rtsTime) &&
        Objects.equals(this.sellerNote, order202507GetOrderDetailResponseDataOrders.sellerNote) &&
        Objects.equals(this.shippingDueTime, order202507GetOrderDetailResponseDataOrders.shippingDueTime) &&
        Objects.equals(this.shippingProvider, order202507GetOrderDetailResponseDataOrders.shippingProvider) &&
        Objects.equals(this.shippingProviderId, order202507GetOrderDetailResponseDataOrders.shippingProviderId) &&
        Objects.equals(this.shippingType, order202507GetOrderDetailResponseDataOrders.shippingType) &&
        Objects.equals(this.splitOrCombineTag, order202507GetOrderDetailResponseDataOrders.splitOrCombineTag) &&
        Objects.equals(this.status, order202507GetOrderDetailResponseDataOrders.status) &&
        Objects.equals(this.trackingNumber, order202507GetOrderDetailResponseDataOrders.trackingNumber) &&
        Objects.equals(this.ttsSlaTime, order202507GetOrderDetailResponseDataOrders.ttsSlaTime) &&
        Objects.equals(this.updateTime, order202507GetOrderDetailResponseDataOrders.updateTime) &&
        Objects.equals(this.userId, order202507GetOrderDetailResponseDataOrders.userId) &&
        Objects.equals(this.warehouseId, order202507GetOrderDetailResponseDataOrders.warehouseId)&&
        Objects.equals(this.additionalProperties, order202507GetOrderDetailResponseDataOrders.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoCombineGroupId, buyerEmail, buyerMessage, cancelOrderSlaTime, cancelReason, cancelTime, cancellationInitiator, channelEntityNationalRegistryId, collectionDueTime, collectionTime, commercePlatform, consultationId, cpf, cpfName, createTime, deliveryDueTime, deliveryOptionId, deliveryOptionName, deliveryOptionRequiredDeliveryTime, deliverySlaTime, deliveryTime, deliveryType, exchangeSourceOrderId, fastDeliveryProgram, fastDispatchSlaTime, fulfillmentType, handlingDuration, hasUpdatedRecipientAddress, id, isBuyerRequestCancel, isCod, isExchangeOrder, isOnHoldOrder, isReplacementOrder, isSampleOrder, lineItems, needUploadInvoice, orderType, packages, paidTime, payment, paymentAuthCode, paymentCardType, paymentMethodCode, paymentMethodName, pickUpCutOffTime, recipientAddress, releaseDate, replacedOrderId, requestCancelTime, rtsSlaTime, rtsTime, sellerNote, shippingDueTime, shippingProvider, shippingProviderId, shippingType, splitOrCombineTag, status, trackingNumber, ttsSlaTime, updateTime, userId, warehouseId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auto_combine_group_id", "buyer_email", "buyer_message", "cancel_order_sla_time", "cancel_reason", "cancel_time", "cancellation_initiator", "channel_entity_national_registry_id", "collection_due_time", "collection_time", "commerce_platform", "consultation_id", "cpf", "cpf_name", "create_time", "delivery_due_time", "delivery_option_id", "delivery_option_name", "delivery_option_required_delivery_time", "delivery_sla_time", "delivery_time", "delivery_type", "exchange_source_order_id", "fast_delivery_program", "fast_dispatch_sla_time", "fulfillment_type", "handling_duration", "has_updated_recipient_address", "id", "is_buyer_request_cancel", "is_cod", "is_exchange_order", "is_on_hold_order", "is_replacement_order", "is_sample_order", "line_items", "need_upload_invoice", "order_type", "packages", "paid_time", "payment", "payment_auth_code", "payment_card_type", "payment_method_code", "payment_method_name", "pick_up_cut_off_time", "recipient_address", "release_date", "replaced_order_id", "request_cancel_time", "rts_sla_time", "rts_time", "seller_note", "shipping_due_time", "shipping_provider", "shipping_provider_id", "shipping_type", "split_or_combine_tag", "status", "tracking_number", "tts_sla_time", "update_time", "user_id", "warehouse_id"));
