...
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.KeywordTarget1;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.LocationTarget1;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.ProductCategoryTarget1;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.ProductTarget1;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.SPKeywordTarget;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.SPLocationTarget;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.SPProductCategoryTarget;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.SPProductTarget;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.SPThemeTarget;
import com.hzltd.module.erplus.adv.adapter.amazon.v2.model.sp.ThemeTarget1;
...
@JsonDeserialize(using = SPTargetDetails.SPTargetDetailsDeserializer.class)
@JsonSerialize(using = SPTargetDetails.SPTargetDetailsSerializer.class)
public class SPTargetDetails extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SPTargetDetails.class.getName());

    public static class SPTargetDetailsSerializer extends StdSerializer<SPTargetDetails> {
        public SPTargetDetailsSerializer(Class<SPTargetDetails> t) {
            super(t);
        }

        public SPTargetDetailsSerializer() {
            this(null);
        }

        @Override
        public void serialize(SPTargetDetails value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SPTargetDetailsDeserializer extends StdDeserializer<SPTargetDetails> {
        public SPTargetDetailsDeserializer() {
            this(SPTargetDetails.class);
        }

        public SPTargetDetailsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SPTargetDetails deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SPTargetDetails ret = new SPTargetDetails();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for SPTargetDetails: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SPTargetDetails getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SPTargetDetails cannot be null");
        }
    }
    ...
    public SPTargetDetails() {
        super("oneOf", Boolean.FALSE);
    }

    public SPTargetDetails(KeywordTarget1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SPTargetDetails(LocationTarget1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SPTargetDetails(ProductCategoryTarget1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SPTargetDetails(ProductTarget1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SPTargetDetails(ThemeTarget1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SPTargetDetails.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SPTargetDetails.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * KeywordTarget1, LocationTarget1, ProductCategoryTarget1, ProductTarget1, ThemeTarget1
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be KeywordTarget1, LocationTarget1, ProductCategoryTarget1, ProductTarget1, ThemeTarget1");
    }
     ...
     * KeywordTarget1, LocationTarget1, ProductCategoryTarget1, ProductTarget1, ThemeTarget1
     *
     * @return The actual instance (KeywordTarget1, LocationTarget1, ProductCategoryTarget1, ProductTarget1, ThemeTarget1)
     */
    @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof LocationTarget1) {
        if (getActualInstance() != null) {
          joiner.add(((LocationTarget1)getActualInstance()).toUrlQueryString(prefix + "one_of_3" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ThemeTarget1) {
        if (getActualInstance() != null) {
          joiner.add(((ThemeTarget1)getActualInstance()).toUrlQueryString(prefix + "one_of_4" + suffix));
        }
        return joiner.toString();
    }
    return null;
