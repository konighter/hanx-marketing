...
public enum SPDeliveryReason {
  ...
  @JsonCreator
  public static SPDeliveryReason fromValue(String value) {
    for (SPDeliveryReason b : SPDeliveryReason.values()) {
