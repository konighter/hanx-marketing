...
public class DayPartTarget {
  ...
  public DayPartTarget dayPartTarget(CreateDayPartTarget dayPartTarget) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DAY_PART_TARGET)
  ...
  @JsonProperty(JSON_PROPERTY_DAY_PART_TARGET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDayPartTarget(CreateDayPartTarget dayPartTarget) {
    this.dayPartTarget = dayPartTarget;
  }
