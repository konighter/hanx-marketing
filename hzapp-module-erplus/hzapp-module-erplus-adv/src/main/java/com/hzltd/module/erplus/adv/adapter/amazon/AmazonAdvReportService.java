...
import com.hzltd.module.erplus.adv.adapter.amazon.v3.AmzSpReportConstants;
...
@Slf4j
@Component
public class AmazonAdvReportService {
...
//            configuration.put("date", "2026-02-10");
    ...
    public void parseAndSave(byte[] gzipContent, AdsSyncTaskDO task, Map<String, String> metadata) {
