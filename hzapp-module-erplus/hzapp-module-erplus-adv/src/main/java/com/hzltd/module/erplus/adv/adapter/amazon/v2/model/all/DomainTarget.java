...
public class DomainTarget {
  ...
  public DomainTarget domainTarget(CreateDomainTarget domainTarget) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DOMAIN_TARGET)
  ...
  @JsonProperty(JSON_PROPERTY_DOMAIN_TARGET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDomainTarget(CreateDomainTarget domainTarget) {
    this.domainTarget = domainTarget;
  }
