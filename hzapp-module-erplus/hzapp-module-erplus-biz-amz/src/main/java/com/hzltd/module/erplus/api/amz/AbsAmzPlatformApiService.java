...
import com.hzltd.module.erplus.model.pricing.OfferModel;
import com.hzltd.module.erplus.model.pricing.PricingModel;
...
import com.hzltd.module.erplus.model.product.RelationShipModel;
...
public class AbsAmzPlatformApiService extends AbsPlatformService {
    ...
    public DefinitionsApi getDefinitionsApi(ApiRequest<?> apiRequest) {
    ...
    public FeesApi getFeesApi(ApiRequest<?> apiRequest) {
        List<String> marketPlaceIds = this.getShopMarkets(apiRequest.getShopId());
    ...
    public FbaInboundApi getFbaInboundApi(ApiRequest<?> apiRequest) {
        List<String> marketPlaceIds = this.getShopMarkets(apiRequest.getShopId());
