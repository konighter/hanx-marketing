...
import com.hzltd.module.erplus.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品条码", requiredMode = Schema.RequiredMode.REQUIRED, example = "清凉小短袖")
    ...
    @Schema(description = "商品单位", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @ExcelProperty("商品单位")
    private Long unitId;
