package com.hzltd.module.erplus.controller.admin.purchase.vo.supplier;

import com.hzltd.framework.common.enums.CommonStatusEnum;
import com.hzltd.framework.common.validation.InEnum;
import com.hzltd.framework.common.validation.Mobile;
import com.hzltd.framework.common.validation.Telephone;
...
public class ErpSupplierSaveReqVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "翰展科技")
