package com.hzltd.module.erplus.controller.admin.property;
...
import com.hzltd.module.erplus.controller.admin.property.vo.value.ProductPropertyValueRespVO;
...
@Tag(name = "管理后台 - 商品属性值")
@RestController
@RequestMapping("/erplus/product/property/value")
@Validated
