...
import com.hzltd.module.erplus.controller.admin.spu.vo.value.ProductPropertyValueRespVO;
import com.hzltd.module.erplus.controller.admin.spu.vo.value.ProductPropertyValueSaveReqVO;
...
@Tag(name = "管理后台 - 商品属性值")
@RestController
@RequestMapping("/erplus/spu/property/value")
@Validated
