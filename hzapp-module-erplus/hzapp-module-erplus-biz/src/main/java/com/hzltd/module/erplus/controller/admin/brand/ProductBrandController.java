package com.hzltd.module.erplus.controller.admin.brand;

import com.hzltd.framework.common.enums.CommonStatusEnum;
import com.hzltd.framework.common.pojo.CommonResult;
import com.hzltd.framework.common.pojo.PageResult;
import com.hzltd.module.erplus.controller.admin.brand.vo.*;
...
@Tag(name = "管理后台 - 商品品牌")
@RestController
@RequestMapping("/erplus/product/brand")
@Validated
public class ProductBrandController {
    ...
    @PreAuthorize("@ss.hasPermission('erp:brand:create')")
    ...
    @PreAuthorize("@ss.hasPermission('erp:brand:update')")
    ...
    @PreAuthorize("@ss.hasPermission('erp:brand:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('erp:brand:query')")
