...
@RestController
@RequestMapping("/erplus/product/spu")
@Validated
public class ProductSpuController {
    ...
    @PreAuthorize("@ss.hasPermission('product:spu:query')")
    public CommonResult<PageResult<ProductSkuRespDetailVO>> getProductSkuPageBySpu(@RequestBody ProductSpuPageReqVO pageReqVO) {
        return CommonResult.success(productSpuService.getSkuPageBySpu(pageReqVO));
    }
