package com.hzltd.module.erplus.dal.dataobject.sale;
...
@KeySequence("erplus_sale_return_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
public class ErpSaleReturnDO extends BaseDO {
     ...
     * 已退款金额，单位：元
     *
     * 目的：和 {@link com.hzltd.module.erplus.dal.dataobject.finance.ErpFinanceReceiptDO} 结合，记录已退款金额
     */
