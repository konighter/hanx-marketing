...
@KeySequence("erplus_sale_out_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
public class ErpSaleOutDO extends BaseDO {
     ...
     * 已收款金额，单位：元
     *
     * 目的：和 {@link com.hzltd.module.erplus.dal.dataobject.finance.ErpFinanceReceiptDO} 结合，记录已收款金额
     */
