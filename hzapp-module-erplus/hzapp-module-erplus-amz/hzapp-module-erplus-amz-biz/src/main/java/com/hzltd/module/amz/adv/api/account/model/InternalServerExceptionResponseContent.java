 ...
 */
@JsonPropertyOrder({
  InternalServerExceptionResponseContent.JSON_PROPERTY_MESSAGE
})
...
public class InternalServerExceptionResponseContent {
  ...
  public InternalServerExceptionResponseContent message(@javax.annotation.Nullable String message) {
  ...
  /**
   * Return true if this InternalServerExceptionResponseContent object is equal to o.
   */
  @Override
