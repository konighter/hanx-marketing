 ...
 */
@JsonPropertyOrder({
  AccessDeniedExceptionResponseContent.JSON_PROPERTY_MESSAGE
})
...
public class AccessDeniedExceptionResponseContent {
  ...
  public AccessDeniedExceptionResponseContent message(@javax.annotation.Nullable String message) {
  ...
  /**
   * Return true if this AccessDeniedExceptionResponseContent object is equal to o.
   */
  @Override
