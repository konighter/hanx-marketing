...
<template>
  <el-form ref="formRef" :model="formData" :rules="rules" label-width="120px" :disabled="isDetail">
    ...
    <el-form-item label="关键字" prop="keywords">
      <MultiTag :data="formData.keyword" :is-detail="false" />
    </el-form-item>

    <el-form-item label="商品卖点" prop="sellPoints">
      <InputGroupUtil :data="formData.sellPoints" />
    </el-form-item>
...
import InputGroupUtil from '@/app/erp/views/product/spu/components/InputGroup/index.vue'
